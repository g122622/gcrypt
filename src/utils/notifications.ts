      ...
      actionButtons: [
        {
          ...
          action: '',
          onClick: () => {
            const updateFileDownloadDir = params?.props?.store?.state?.appPaths?.updateDownloadDir
            const updateFileName = params?.props?.info?.filename
            const updateFilePath = `${updateFileDownloadDir}/${updateFileName}`
...
function update (notification, params = null) {
